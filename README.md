...
|---------------------------------------------------------------|--------------------------------------------------------------------------------------------------------|--------------
| GET /customs-data-store/eori/:eori/verified-email             | Retrieve the verified email address for a given EORI either from the cache or SUB09                    | <span style="color: red">Will be decommissioned soon</span>
| GET /customs-data-store/eori/:eori/company-information        | Retrieves the business full name and address for the given EORI                                        | <span style="color: red">Will be decommissioned soon</span>
| GET /customs-data-store/eori/:eori/eori-history               | Retrieves the historic eori's for a given EORI either from the cache or SUB21                          | <span style="color: red">Will be decommissioned soon</span>
| GET /customs-data-store/eori/:eori/xieori-information         | Retrieves the XI EORI information for the EORI (provided in URI) either from the cache or SUB09        | <span style="color: red">Will be decommissioned soon</span>
...
## GET /eori/:eori/verified-email (<span style="color: red">Will be decommissioned soon</span>)
...
## GET /eori/:eori/company-information (<span style="color: red">Will be decommissioned soon<span>)
...
## GET /eori/:eori/eori-history (<span style="color: red">Will be decommissioned soon</span>)
...
## GET /eori/:eori/xieori-information (<span style="color: red">Will be decommissioned soon</span>)
