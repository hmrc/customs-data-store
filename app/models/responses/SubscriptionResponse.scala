...
case class SubscriptionDisplayResponse(responseCommon: SubResponseCommon,
                                       responseDetail: SubResponseDetail)
...
case class SubResponseCommon(status: String,
                          statusText: Option[String],
                          processingDate: String,
                          returnParameters: Option[Array[ReturnParameters]])

case class SubResponseDetail(EORINo: Option[EORI],
